...
para arreglar esto, cambiamos el metodo ´saltar´,para que salte bien a su y se le resta ´altoAuto / 2 + espacioEntreAutos´,de esta forma saltaria 
...
image::este Equipo/Documentos/SaltoConejo.png[]
...
necesitamos y como estos se relacionan entre si. Creemos que el pensar mucho el nombre de las variables nos va a quedar para siempre y que
...
En conclusión, una simple taza de cafe, unos buenos mates, mucha práctica, el seguimiento del profesor, el espacio de consultas,
