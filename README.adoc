...
Tambien agregamos la varible vidas en conejo lo cual estaba mal ya que el conejo
...
Tuvimos problemas con la colicion de los rasengans y autos, estos se destruian pero de a muchos,luego de revisar el
...
el juego funcionó bien, el rasengan se elimino,se movio y dibujo bien
