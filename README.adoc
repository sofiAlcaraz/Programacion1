...
*funcionamiento*
El juego  comienza con un menu que tiene dosopciones jugar y salir,en culquier momento de la partida ésta se puede pausar,
...
todo lo necesario, se chequean las coliciones, en caso de ser necesario se eliminan, agregan cosas o suman cosas,se chequean las teclas,
