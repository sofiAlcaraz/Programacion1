...
----
La clase Menu tiene como estados: double posicionDelBotonJugarX, double posicionDelBotonJugarY,
double posicionDelBotonSalirX, double posicionDelBotonSalirY, double posicionDelCursorX, double posicionDelCursorY, y dos Image,
