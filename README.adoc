...
Auto.java[]
----
La Clase Auto tine como estados:double alto,double ancho,double x,double y, double velocidad,boolean sentido,double bajadaDePantalla,
Image imagenAuto.
...
El metodo avanzar lo que hace es que el auto avance para cierto lado segun su sentido,sumando a su x la velocidad o restando segun cual 
